...
class Inpainter():
    ...
    def inpaint(self):
        ...
        while stay:
            ...
            # cv2.imshow("updatedMask.jpg", self.updatedMask)
            cv2.imshow("workImage.jpg", self.workImage)
            cv2.waitKey(1)
    ...
    def calculateGradients(self):
        # TODO: check type CV_BGR2GRAY
        srcGray = cv2.cvtColor(self.workImage, cv2.COLOR_BGR2GRAY)

        # default parameter: scale shoule be 1
